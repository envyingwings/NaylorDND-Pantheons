...
Divine Domains:
  ...
  - Order
  - War
Portfolio: Black Handed God of Conflict | Discipline, Strategy, Warfare, and patron god of Goblinoids
Status:
...
- [[#Appendix|Appendix]]
	- [[#Appendix#The Goblin Host — Goblinoid Pantheon|The Goblin Host — Goblinoid Pantheon]]
===
### Bane, the Strife Emperor
[Miraheze](https://criticalrole.miraheze.org/wiki/Bane) | [Forgotten Realms Wiki](https://forgottenrealms.fandom.com/wiki/Bane)
![[BaneSymbol.webp]]
**Alignment.** Lawful Evil
**Symbol.** A steel gauntlet clutching a rusted chain
**Portfolio.** Greater God of Conflict, Discipline, Oppression, Strategy, Warfare and patron of Goblinkind
**Divine Realm.** [[Myriad Battlefields of Acheron|Banehold, Myriad Battlefields of Acheron]]
**Worshippers.** Goblinoids, conquerors, tyrants, and warlords
```
**Titles:** Strife Emperor, the Black Hand
...
### Appendix
#### The Goblin Host — Goblinoid Pantheon
```datacards
TABLE WITHOUT ID
  file.link AS "",
  cover
FROM #GoblinoidPantheon
WHERE !contains(file.name, "Bane, The Strife Emperor")
