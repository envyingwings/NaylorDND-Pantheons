...
Divine Domains:
  ...
  - Death
  - Trickery
Portfolio: God of Pain, Jailers, Caves, the Underdark, Aberrations, Disability, Enslavement, and Torture
Status:
...
[Miraheze](https://criticalrole.miraheze.org/wiki/Torog) | [Forgotten Realms Wiki](https://forgottenrealms.fandom.com/wiki/Torog)
![[TorogSymbol.webp]]
**Alignment.** Neutral Evil
**Symbol.** Three pale arms clawing from a dark void
**Portfolio.** Greater God of Pain, Suffering, Disability, Imprisonment, and the Underdark
**Divine Realm.** [[Tartarean Depths of Carceri]]
**Worshippers.** Jailers, slavers, torturers
```
**Titles:** The King that Crawls, The Lame God, Warden of Carceri
