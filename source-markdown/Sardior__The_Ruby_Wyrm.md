...
[Forgotten Realms Wiki](https://forgottenrealms.fandom.com/wiki/Sardior)
![[Sardior3.png]]
**Alignment.** Neutral
...
```
**Titles:** Ruby Wyrm, Master of Gem Dragons, Prince of Neutral Dragons
**Domains:** Arcana, Knowledge, Trickery
### Commandments of Sardior
- Respect and harness the power of the mind, for it is the greatest tool and weapon.
- Uphold the balance of power and use it responsibly, for misuse leads to corruption and destruction.
- Embrace solitude as a path to self-discovery and enlightenment, but remember the importance of connection and empathy for others.
### Appendix
